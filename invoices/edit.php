...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($customer_id <= 0) {
        ...
        try {
            ...
            redirect('/inv/invoices/list.php?msg=' . urlencode("Invoice '{$invoice['invoice_no']}' successfully updated."));
        } catch (Exception $e) {
...
<div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
    ...
    <div class="flex space-x-3">
        <a href="/inv/invoices/view.php?id=<?= $id ?>" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-xl shadow-sm transition-all flex items-center">
