                    ...
                    function updateCustomerDetails() {
                        ...
                        if (id && customersData[id]) {
                            ...
                            setTimeout(() => {
                                ...
                                if (isStandard) {
                                    badge.className = "ml-auto px-3 py-1.5 rounded-full text-xs font-bold bg-purple-100 text-purple-700 border border-purple-200 uppercase tracking-wider flex items-center shadow-sm animate-auto-float cursor-default";
                                    badge.innerHTML = '<i data-lucide="shield-check" class="w-4 h-4 mr-1.5"></i> Standard (B2B)';
                                } else {
                                    badge.className = "ml-auto px-3 py-1.5 rounded-full text-xs font-bold bg-blue-100 text-blue-700 border border-blue-200 uppercase tracking-wider flex items-center shadow-sm animate-auto-float cursor-default";
